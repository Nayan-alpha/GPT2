...
class CNN_Encoder(tf.keras.Model):
    ...
    def call(self, images):
        ...
        print("Print type of tags_predictions: ",type(tags_predictions))
        print("tags Predictions shape: ",tags_predictions.shape)
        print("tags Predictions: ",tags_predictions)
        print("Tags Predictions shape: ",tags_predictions.shape)
        print("Visual Featues Shape: ",visual_features.shape)
